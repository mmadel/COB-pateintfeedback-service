...
public interface ClinicalFeedbackPerformanceRepository extends PerformanceRepository {
    ...
    @Query(value = "select patient_name,JSON_EXTRACT(feedback_questions, '$.clinicalFeedback'),optional_feedback , created_at, clinic_id  from patient_feedback a " +
            ...
            "and JSON_EXTRACT(feedback_questions, '$.clinicalFeedback') IN :feedback", nativeQuery = true)
    List<Object> find(Long startDate, Long endDate, List<Long> clinicIds, List<String> feedback);
}
